...
<link rel="stylesheet" href="/themes/cart/codex_framework/assets/css/configure.css?v=1.0.1">
<script src="/themes/cart/codex_framework/assets/js/configure.js?v=1.0.1"></script>
