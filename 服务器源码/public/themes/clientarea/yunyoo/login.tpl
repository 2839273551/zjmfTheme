...
<style>
	 ...
	 background: linear-gradient(358deg, #e0c3fc, #8ec5fc) !important;
		}
</style>
			...
			<div class="row align-items-center justify-content-center min-vh-100">
				<div class="col-md-7 col-lg-6 col-xl-5 py-6 py-md-0">
					<div class="card shadow zindex-100 mb-0 overflow-hidden rounded-lg semi-transparent-white-bg">
						...
						<div class="mb-1 d-flex justify-content-center"><a href="{$Setting.web_jump_url}" one-link-mark="yes">云信网络</a></div>
						<div class="p-1 bg-info"></div>
					</div>
				</div>
			</div>
