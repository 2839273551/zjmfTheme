	...
	<div class="card-body">
		<div class="table-container">
			<div class="table-header">
				...
				<span style="color: #e53333; text-shadow: 2px 2px 4px rgba(229, 51, 51, 0.6);"><span style="color: #0e3bff;">温馨提示：</span><span style="color: #c500ff;">服务器数据做好备份！数据丢失概不负责！</span></span>
							{/if}
						</div>
					</div>
				</div>
